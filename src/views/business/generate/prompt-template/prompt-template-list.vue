...
import PromptTemplateForm from '/@/views/business/generate/prompt-template/prompt-template-form.vue';
...
async function queryData() {
  ...
  try {
    const queryResult = await promptTemplateApi.queryPage(queryForm);
...
async function requestBatchDelete() {
  SmartLoading.show();
    try {
      await promptTemplateApi.batchDelete(selectedRowKeyList.value);
