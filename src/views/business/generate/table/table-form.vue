...
-->
<template>
  <a-drawer :title="form.tableId ? '编辑' : '添加'" :width="1200" :open="visibleFlag" @close="onClose" :maskClosable="false" :destroyOnClose="true">
    <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }">
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="表状态" name="table_type">
            <DictSelect width="100%" v-model:value="form.tableType" :dict-code="DICT_CODE_ENUM.TABLE_TYPE" placeholder="表状态" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="编辑组件" name="editComponent">
            <DictSelect
              width="100%"
              v-model:value="form.editComponent"
