      ...
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="数据源类型" name="databaseType">
            <DictSelect width="100%" v-model:value="form.databaseType"
                        :dict-code="DICT_CODE_ENUM.DATABASE_TYPE || 'DATABASE_TYPE'" placeholder="类型"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="密码" name="password">
            <a-input type="password" style="width: 100%" v-model:value="form.password" placeholder="密码"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="后端日期" name="backendDate">
            <a-date-picker show-time valueFormat="YYYY-MM-DD HH:mm:ss" v-model:value="form.backendDate"
                           style="width: 100%" placeholder="后端日期"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="前端日期" name="frontDate">
            <a-date-picker show-time valueFormat="YYYY-MM-DD HH:mm:ss" v-model:value="form.frontDate"
                           style="width: 100%" placeholder="前端日期"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-item label="模型名称" name="moduleName">
            <a-input style="width: 100%" v-model:value="form.moduleName" placeholder="模型名称"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
...
function show(rowData) {
  showForm(form, rowData, formDefault)
...
const rules = {
  ...
  copyright: [{required: true, message: '版权信息 必填'}],
  frontAuthor: [{required: true, message: '前端作者 必填'}],
  packageName: [{required: true, message: '包名称 必填'}],
  moduleName: [{required: true, message: '模型名称 必填'}],
